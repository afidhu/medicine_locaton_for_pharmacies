...
class MedicinesEntity extends Equatable{
  ...
  const  MedicinesEntity({required this.medId, required this.medName, required this.medType, required this.medPrice, required this.medImage, required this.medDescription, required this.distanceFromUser, required this.rates, required this.reviews, this.availability =true, required this.pharmacy});
